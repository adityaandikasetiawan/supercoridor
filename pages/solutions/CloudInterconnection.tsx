...
export function CloudInterconnection() {
  const content = usePageContent('solutions-cloud-interconnection', {
    ...
    heroImage: 'https://images.unsplash.com/photo-1667984390553-7f439e6ae401?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjbG91ZCUyMGNvbXB1dGluZyUyMHRlY2hub2xvZ3l8ZW58MXx8fHwxNzY3Mjk4NDA2fDA&ixlib=rb-4.1.0&q=80&w=1080',
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            <div>
              <h2 className="font-bold text-3xl mb-6">Seamless Cloud Connectivity</h2>
          ...
          {/* Cloud Partners */}
          <div className="mb-16">
            <h2 className="font-bold text-3xl mb-8 text-center">Supported Cloud Platforms</h2>
            <div className="grid md:grid-cols-3 gap-8">
              {content.cloudPartners.map((partner, index) => (
                <div key={index} className="bg-green-50 p-6 rounded-lg text-center">
                  <h3 className="font-bold text-xl mb-3 text-green-600">{partner.title}</h3>
          ...
          {/* Features Grid */}
          <div className="mb-16">
            <h2 className="font-bold text-3xl mb-8 text-center">Key Features</h2>
            <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-gray-50 rounded-lg p-8 mb-16">
            <h2 className="font-bold text-3xl mb-6 text-center">Use Cases</h2>
